...
namespace util{
    ...
    namespace bitboard{
        ...
        namespace {
            ...
            struct ray{
                const static U64 value = (pt == bishop ? util::bitboard::battack[sq] : (pt == rook ? util::bitboard::rattack[sq] : util::bitboard::qattack[sq]))
                                       & (dir%2 ? ((dir-1)%4 ? util::bitboard::amasks[sq] : util::bitboard::dmasks[sq]) : (dir%4 ? util::bitboard::fmasks[sq] :  util::bitboard::rmasks[sq]))
                                       & (dir>3 ? util::constants::ALL_ >> (63-sq) : util::constants::ALL_ << sq);
            };
        }
        ...
        const std::array<std::array<std::array<U64, 8>, 64>, 3> rays = {
            ray<bishop, 0, 0>::value, ray<bishop, 0,1>::value, ray<bishop, 0, 2>::value, ray<bishop, 0,3>::value, ray<bishop, 0,4>::value, ray<bishop, 0,5>::value, ray<bishop, 0, 6>::value, ray<bishop, 0,7>::value,
            ray<bishop, 1, 0>::value, ray<bishop, 1,1>::value, ray<bishop, 1, 2>::value, ray<bishop, 1,3>::value, ray<bishop, 1,4>::value, ray<bishop, 1,5>::value, ray<bishop, 1, 6>::value, ray<bishop, 1,7>::value,
            ray<bishop, 2, 0>::value, ray<bishop, 2,1>::value, ray<bishop, 2, 2>::value, ray<bishop, 2,3>::value, ray<bishop, 2,4>::value, ray<bishop, 2,5>::value, ray<bishop, 2, 6>::value, ray<bishop, 2,7>::value,
            ray<bishop, 3, 0>::value, ray<bishop, 3,1>::value, ray<bishop, 3, 2>::value, ray<bishop, 3,3>::value, ray<bishop, 3,4>::value, ray<bishop, 3,5>::value, ray<bishop, 3, 6>::value, ray<bishop, 3,7>::value,
            ray<bishop, 4, 0>::value, ray<bishop, 4,1>::value, ray<bishop, 4, 2>::value, ray<bishop, 4,3>::value, ray<bishop, 4,4>::value, ray<bishop, 4,5>::value, ray<bishop, 4, 6>::value, ray<bishop, 4,7>::value,
            ray<bishop, 5, 0>::value, ray<bishop, 5,1>::value, ray<bishop, 5, 2>::value, ray<bishop, 5,3>::value, ray<bishop, 5,4>::value, ray<bishop, 5,5>::value, ray<bishop, 5, 6>::value, ray<bishop, 5,7>::value,
            ray<bishop, 6, 0>::value, ray<bishop, 6,1>::value, ray<bishop, 6, 2>::value, ray<bishop, 6,3>::value, ray<bishop, 6,4>::value, ray<bishop, 6,5>::value, ray<bishop, 6, 6>::value, ray<bishop, 6,7>::value,
            ray<bishop, 7, 0>::value, ray<bishop, 7,1>::value, ray<bishop, 7, 2>::value, ray<bishop, 7,3>::value, ray<bishop, 7,4>::value, ray<bishop, 7,5>::value, ray<bishop, 7, 6>::value, ray<bishop, 7,7>::value,
            ray<bishop, 8, 0>::value, ray<bishop, 8,1>::value, ray<bishop, 8, 2>::value, ray<bishop, 8,3>::value, ray<bishop, 8,4>::value, ray<bishop, 8,5>::value, ray<bishop, 8, 6>::value, ray<bishop, 8,7>::value,
            ray<bishop, 9, 0>::value, ray<bishop, 9,1>::value, ray<bishop, 9, 2>::value, ray<bishop, 9,3>::value, ray<bishop, 9,4>::value, ray<bishop, 9,5>::value, ray<bishop, 9, 6>::value, ray<bishop, 9,7>::value,
            ray<bishop,10, 0>::value, ray<bishop,10,1>::value, ray<bishop,10, 2>::value, ray<bishop,10,3>::value, ray<bishop,10,4>::value, ray<bishop,10,5>::value, ray<bishop,10, 6>::value, ray<bishop,10,7>::value,
            ray<bishop,11, 0>::value, ray<bishop,11,1>::value, ray<bishop,11, 2>::value, ray<bishop,11,3>::value, ray<bishop,11,4>::value, ray<bishop,11,5>::value, ray<bishop,11, 6>::value, ray<bishop,11,7>::value,
            ray<bishop,12, 0>::value, ray<bishop,12,1>::value, ray<bishop,12, 2>::value, ray<bishop,12,3>::value, ray<bishop,12,4>::value, ray<bishop,12,5>::value, ray<bishop,12, 6>::value, ray<bishop,12,7>::value,
            ray<bishop,13, 0>::value, ray<bishop,13,1>::value, ray<bishop,13, 2>::value, ray<bishop,13,3>::value, ray<bishop,13,4>::value, ray<bishop,13,5>::value, ray<bishop,13, 6>::value, ray<bishop,13,7>::value,
            ray<bishop,14, 0>::value, ray<bishop,14,1>::value, ray<bishop,14, 2>::value, ray<bishop,14,3>::value, ray<bishop,14,4>::value, ray<bishop,14,5>::value, ray<bishop,14, 6>::value, ray<bishop,14,7>::value,
            ray<bishop,15, 0>::value, ray<bishop,15,1>::value, ray<bishop,15, 2>::value, ray<bishop,15,3>::value, ray<bishop,15,4>::value, ray<bishop,15,5>::value, ray<bishop,15, 6>::value, ray<bishop,15,7>::value,
            ray<bishop,16, 0>::value, ray<bishop,16,1>::value, ray<bishop,16, 2>::value, ray<bishop,16,3>::value, ray<bishop,16,4>::value, ray<bishop,16,5>::value, ray<bishop,16, 6>::value, ray<bishop,16,7>::value,
            ray<bishop,17, 0>::value, ray<bishop,17,1>::value, ray<bishop,17, 2>::value, ray<bishop,17,3>::value, ray<bishop,17,4>::value, ray<bishop,17,5>::value, ray<bishop,17, 6>::value, ray<bishop,17,7>::value,
            ray<bishop,18, 0>::value, ray<bishop,18,1>::value, ray<bishop,18, 2>::value, ray<bishop,18,3>::value, ray<bishop,18,4>::value, ray<bishop,18,5>::value, ray<bishop,18, 6>::value, ray<bishop,18,7>::value,
            ray<bishop,19, 0>::value, ray<bishop,19,1>::value, ray<bishop,19, 2>::value, ray<bishop,19,3>::value, ray<bishop,19,4>::value, ray<bishop,19,5>::value, ray<bishop,19, 6>::value, ray<bishop,19,7>::value,
            ray<bishop,20, 0>::value, ray<bishop,20,1>::value, ray<bishop,20, 2>::value, ray<bishop,20,3>::value, ray<bishop,20,4>::value, ray<bishop,20,5>::value, ray<bishop,20, 6>::value, ray<bishop,20,7>::value,
            ray<bishop,21, 0>::value, ray<bishop,21,1>::value, ray<bishop,21, 2>::value, ray<bishop,21,3>::value, ray<bishop,21,4>::value, ray<bishop,21,5>::value, ray<bishop,21, 6>::value, ray<bishop,21,7>::value,
            ray<bishop,22, 0>::value, ray<bishop,22,1>::value, ray<bishop,22, 2>::value, ray<bishop,22,3>::value, ray<bishop,22,4>::value, ray<bishop,22,5>::value, ray<bishop,22, 6>::value, ray<bishop,22,7>::value,
            ray<bishop,23, 0>::value, ray<bishop,23,1>::value, ray<bishop,23, 2>::value, ray<bishop,23,3>::value, ray<bishop,23,4>::value, ray<bishop,23,5>::value, ray<bishop,23, 6>::value, ray<bishop,23,7>::value,
            ray<bishop,24, 0>::value, ray<bishop,24,1>::value, ray<bishop,24, 2>::value, ray<bishop,24,3>::value, ray<bishop,24,4>::value, ray<bishop,24,5>::value, ray<bishop,24, 6>::value, ray<bishop,24,7>::value,
            ray<bishop,25, 0>::value, ray<bishop,25,1>::value, ray<bishop,25, 2>::value, ray<bishop,25,3>::value, ray<bishop,25,4>::value, ray<bishop,25,5>::value, ray<bishop,25, 6>::value, ray<bishop,25,7>::value,
            ray<bishop,26, 0>::value, ray<bishop,26,1>::value, ray<bishop,26, 2>::value, ray<bishop,26,3>::value, ray<bishop,26,4>::value, ray<bishop,26,5>::value, ray<bishop,26, 6>::value, ray<bishop,26,7>::value,
            ray<bishop,27, 0>::value, ray<bishop,27,1>::value, ray<bishop,27, 2>::value, ray<bishop,27,3>::value, ray<bishop,27,4>::value, ray<bishop,27,5>::value, ray<bishop,27, 6>::value, ray<bishop,27,7>::value,
            ray<bishop,28, 0>::value, ray<bishop,28,1>::value, ray<bishop,28, 2>::value, ray<bishop,28,3>::value, ray<bishop,28,4>::value, ray<bishop,28,5>::value, ray<bishop,28, 6>::value, ray<bishop,28,7>::value,
            ray<bishop,29, 0>::value, ray<bishop,29,1>::value, ray<bishop,29, 2>::value, ray<bishop,29,3>::value, ray<bishop,29,4>::value, ray<bishop,29,5>::value, ray<bishop,29, 6>::value, ray<bishop,29,7>::value,
            ray<bishop,30, 0>::value, ray<bishop,30,1>::value, ray<bishop,30, 2>::value, ray<bishop,30,3>::value, ray<bishop,30,4>::value, ray<bishop,30,5>::value, ray<bishop,30, 6>::value, ray<bishop,30,7>::value,
            ray<bishop,31, 0>::value, ray<bishop,31,1>::value, ray<bishop,31, 2>::value, ray<bishop,31,3>::value, ray<bishop,31,4>::value, ray<bishop,31,5>::value, ray<bishop,31, 6>::value, ray<bishop,31,7>::value,
            ray<bishop,32, 0>::value, ray<bishop,32,1>::value, ray<bishop,32, 2>::value, ray<bishop,32,3>::value, ray<bishop,32,4>::value, ray<bishop,32,5>::value, ray<bishop,32, 6>::value, ray<bishop,32,7>::value,
            ray<bishop,33, 0>::value, ray<bishop,33,1>::value, ray<bishop,33, 2>::value, ray<bishop,33,3>::value, ray<bishop,33,4>::value, ray<bishop,33,5>::value, ray<bishop,33, 6>::value, ray<bishop,33,7>::value,
            ray<bishop,34, 0>::value, ray<bishop,34,1>::value, ray<bishop,34, 2>::value, ray<bishop,34,3>::value, ray<bishop,34,4>::value, ray<bishop,34,5>::value, ray<bishop,34, 6>::value, ray<bishop,34,7>::value,
            ray<bishop,35, 0>::value, ray<bishop,35,1>::value, ray<bishop,35, 2>::value, ray<bishop,35,3>::value, ray<bishop,35,4>::value, ray<bishop,35,5>::value, ray<bishop,35, 6>::value, ray<bishop,35,7>::value,
            ray<bishop,36, 0>::value, ray<bishop,36,1>::value, ray<bishop,36, 2>::value, ray<bishop,36,3>::value, ray<bishop,36,4>::value, ray<bishop,36,5>::value, ray<bishop,36, 6>::value, ray<bishop,36,7>::value,
            ray<bishop,37, 0>::value, ray<bishop,37,1>::value, ray<bishop,37, 2>::value, ray<bishop,37,3>::value, ray<bishop,37,4>::value, ray<bishop,37,5>::value, ray<bishop,37, 6>::value, ray<bishop,37,7>::value,
            ray<bishop,38, 0>::value, ray<bishop,38,1>::value, ray<bishop,38, 2>::value, ray<bishop,38,3>::value, ray<bishop,38,4>::value, ray<bishop,38,5>::value, ray<bishop,38, 6>::value, ray<bishop,38,7>::value,
            ray<bishop,39, 0>::value, ray<bishop,39,1>::value, ray<bishop,39, 2>::value, ray<bishop,39,3>::value, ray<bishop,39,4>::value, ray<bishop,39,5>::value, ray<bishop,39, 6>::value, ray<bishop,39,7>::value,
            ray<bishop,40, 0>::value, ray<bishop,40,1>::value, ray<bishop,40, 2>::value, ray<bishop,40,3>::value, ray<bishop,40,4>::value, ray<bishop,40,5>::value, ray<bishop,40, 6>::value, ray<bishop,40,7>::value,
            ray<bishop,41, 0>::value, ray<bishop,41,1>::value, ray<bishop,41, 2>::value, ray<bishop,41,3>::value, ray<bishop,41,4>::value, ray<bishop,41,5>::value, ray<bishop,41, 6>::value, ray<bishop,41,7>::value,
            ray<bishop,42, 0>::value, ray<bishop,42,1>::value, ray<bishop,42, 2>::value, ray<bishop,42,3>::value, ray<bishop,42,4>::value, ray<bishop,42,5>::value, ray<bishop,42, 6>::value, ray<bishop,42,7>::value,
            ray<bishop,43, 0>::value, ray<bishop,43,1>::value, ray<bishop,43, 2>::value, ray<bishop,43,3>::value, ray<bishop,43,4>::value, ray<bishop,43,5>::value, ray<bishop,43, 6>::value, ray<bishop,43,7>::value,
            ray<bishop,44, 0>::value, ray<bishop,44,1>::value, ray<bishop,44, 2>::value, ray<bishop,44,3>::value, ray<bishop,44,4>::value, ray<bishop,44,5>::value, ray<bishop,44, 6>::value, ray<bishop,44,7>::value,
            ray<bishop,45, 0>::value, ray<bishop,45,1>::value, ray<bishop,45, 2>::value, ray<bishop,45,3>::value, ray<bishop,45,4>::value, ray<bishop,45,5>::value, ray<bishop,45, 6>::value, ray<bishop,45,7>::value,
            ray<bishop,46, 0>::value, ray<bishop,46,1>::value, ray<bishop,46, 2>::value, ray<bishop,46,3>::value, ray<bishop,46,4>::value, ray<bishop,46,5>::value, ray<bishop,46, 6>::value, ray<bishop,46,7>::value,
            ray<bishop,47, 0>::value, ray<bishop,47,1>::value, ray<bishop,47, 2>::value, ray<bishop,47,3>::value, ray<bishop,47,4>::value, ray<bishop,47,5>::value, ray<bishop,47, 6>::value, ray<bishop,47,7>::value,
            ray<bishop,48, 0>::value, ray<bishop,48,1>::value, ray<bishop,48, 2>::value, ray<bishop,48,3>::value, ray<bishop,48,4>::value, ray<bishop,48,5>::value, ray<bishop,48, 6>::value, ray<bishop,48,7>::value,
            ray<bishop,49, 0>::value, ray<bishop,49,1>::value, ray<bishop,49, 2>::value, ray<bishop,49,3>::value, ray<bishop,49,4>::value, ray<bishop,49,5>::value, ray<bishop,49, 6>::value, ray<bishop,49,7>::value,
            ray<bishop,50, 0>::value, ray<bishop,50,1>::value, ray<bishop,50, 2>::value, ray<bishop,50,3>::value, ray<bishop,50,4>::value, ray<bishop,50,5>::value, ray<bishop,50, 6>::value, ray<bishop,50,7>::value,
            ray<bishop,51, 0>::value, ray<bishop,51,1>::value, ray<bishop,51, 2>::value, ray<bishop,51,3>::value, ray<bishop,51,4>::value, ray<bishop,51,5>::value, ray<bishop,51, 6>::value, ray<bishop,51,7>::value,
            ray<bishop,52, 0>::value, ray<bishop,52,1>::value, ray<bishop,52, 2>::value, ray<bishop,52,3>::value, ray<bishop,52,4>::value, ray<bishop,52,5>::value, ray<bishop,52, 6>::value, ray<bishop,52,7>::value,
            ray<bishop,53, 0>::value, ray<bishop,53,1>::value, ray<bishop,53, 2>::value, ray<bishop,53,3>::value, ray<bishop,53,4>::value, ray<bishop,53,5>::value, ray<bishop,53, 6>::value, ray<bishop,53,7>::value,
            ray<bishop,54, 0>::value, ray<bishop,54,1>::value, ray<bishop,54, 2>::value, ray<bishop,54,3>::value, ray<bishop,54,4>::value, ray<bishop,54,5>::value, ray<bishop,54, 6>::value, ray<bishop,54,7>::value,
            ray<bishop,55, 0>::value, ray<bishop,55,1>::value, ray<bishop,55, 2>::value, ray<bishop,55,3>::value, ray<bishop,55,4>::value, ray<bishop,55,5>::value, ray<bishop,55, 6>::value, ray<bishop,55,7>::value,
            ray<bishop,56, 0>::value, ray<bishop,56,1>::value, ray<bishop,56, 2>::value, ray<bishop,56,3>::value, ray<bishop,56,4>::value, ray<bishop,56,5>::value, ray<bishop,56, 6>::value, ray<bishop,56,7>::value,
            ray<bishop,57, 0>::value, ray<bishop,57,1>::value, ray<bishop,57, 2>::value, ray<bishop,57,3>::value, ray<bishop,57,4>::value, ray<bishop,57,5>::value, ray<bishop,57, 6>::value, ray<bishop,57,7>::value,
            ray<bishop,58, 0>::value, ray<bishop,58,1>::value, ray<bishop,58, 2>::value, ray<bishop,58,3>::value, ray<bishop,58,4>::value, ray<bishop,58,5>::value, ray<bishop,58, 6>::value, ray<bishop,58,7>::value,
            ray<bishop,59, 0>::value, ray<bishop,59,1>::value, ray<bishop,59, 2>::value, ray<bishop,59,3>::value, ray<bishop,59,4>::value, ray<bishop,59,5>::value, ray<bishop,59, 6>::value, ray<bishop,59,7>::value,
            ray<bishop,60, 0>::value, ray<bishop,60,1>::value, ray<bishop,60, 2>::value, ray<bishop,60,3>::value, ray<bishop,60,4>::value, ray<bishop,60,5>::value, ray<bishop,60, 6>::value, ray<bishop,60,7>::value,
            ray<bishop,61, 0>::value, ray<bishop,61,1>::value, ray<bishop,61, 2>::value, ray<bishop,61,3>::value, ray<bishop,61,4>::value, ray<bishop,61,5>::value, ray<bishop,61, 6>::value, ray<bishop,61,7>::value,
            ray<bishop,62, 0>::value, ray<bishop,62,1>::value, ray<bishop,62, 2>::value, ray<bishop,62,3>::value, ray<bishop,62,4>::value, ray<bishop,62,5>::value, ray<bishop,62, 6>::value, ray<bishop,62,7>::value,
            ray<bishop,63, 0>::value, ray<bishop,63,1>::value, ray<bishop,63, 2>::value, ray<bishop,63,3>::value, ray<bishop,63,4>::value, ray<bishop,63,5>::value, ray<bishop,63, 6>::value, ray<bishop,63,7>::value,
            ray<  rook, 0, 0>::value, ray<  rook, 0,1>::value, ray<  rook, 0, 2>::value, ray<  rook, 0,3>::value, ray<  rook, 0,4>::value, ray<  rook, 0,5>::value, ray<  rook, 0, 6>::value, ray<  rook, 0,7>::value,
            ray<  rook, 1, 0>::value, ray<  rook, 1,1>::value, ray<  rook, 1, 2>::value, ray<  rook, 1,3>::value, ray<  rook, 1,4>::value, ray<  rook, 1,5>::value, ray<  rook, 1, 6>::value, ray<  rook, 1,7>::value,
            ray<  rook, 2, 0>::value, ray<  rook, 2,1>::value, ray<  rook, 2, 2>::value, ray<  rook, 2,3>::value, ray<  rook, 2,4>::value, ray<  rook, 2,5>::value, ray<  rook, 2, 6>::value, ray<  rook, 2,7>::value,
            ray<  rook, 3, 0>::value, ray<  rook, 3,1>::value, ray<  rook, 3, 2>::value, ray<  rook, 3,3>::value, ray<  rook, 3,4>::value, ray<  rook, 3,5>::value, ray<  rook, 3, 6>::value, ray<  rook, 3,7>::value,
            ray<  rook, 4, 0>::value, ray<  rook, 4,1>::value, ray<  rook, 4, 2>::value, ray<  rook, 4,3>::value, ray<  rook, 4,4>::value, ray<  rook, 4,5>::value, ray<  rook, 4, 6>::value, ray<  rook, 4,7>::value,
            ray<  rook, 5, 0>::value, ray<  rook, 5,1>::value, ray<  rook, 5, 2>::value, ray<  rook, 5,3>::value, ray<  rook, 5,4>::value, ray<  rook, 5,5>::value, ray<  rook, 5, 6>::value, ray<  rook, 5,7>::value,
            ray<  rook, 6, 0>::value, ray<  rook, 6,1>::value, ray<  rook, 6, 2>::value, ray<  rook, 6,3>::value, ray<  rook, 6,4>::value, ray<  rook, 6,5>::value, ray<  rook, 6, 6>::value, ray<  rook, 6,7>::value,
            ray<  rook, 7, 0>::value, ray<  rook, 7,1>::value, ray<  rook, 7, 2>::value, ray<  rook, 7,3>::value, ray<  rook, 7,4>::value, ray<  rook, 7,5>::value, ray<  rook, 7, 6>::value, ray<  rook, 7,7>::value,
            ray<  rook, 8, 0>::value, ray<  rook, 8,1>::value, ray<  rook, 8, 2>::value, ray<  rook, 8,3>::value, ray<  rook, 8,4>::value, ray<  rook, 8,5>::value, ray<  rook, 8, 6>::value, ray<  rook, 8,7>::value,
            ray<  rook, 9, 0>::value, ray<  rook, 9,1>::value, ray<  rook, 9, 2>::value, ray<  rook, 9,3>::value, ray<  rook, 9,4>::value, ray<  rook, 9,5>::value, ray<  rook, 9, 6>::value, ray<  rook, 9,7>::value,
            ray<  rook,10, 0>::value, ray<  rook,10,1>::value, ray<  rook,10, 2>::value, ray<  rook,10,3>::value, ray<  rook,10,4>::value, ray<  rook,10,5>::value, ray<  rook,10, 6>::value, ray<  rook,10,7>::value,
            ray<  rook,11, 0>::value, ray<  rook,11,1>::value, ray<  rook,11, 2>::value, ray<  rook,11,3>::value, ray<  rook,11,4>::value, ray<  rook,11,5>::value, ray<  rook,11, 6>::value, ray<  rook,11,7>::value,
            ray<  rook,12, 0>::value, ray<  rook,12,1>::value, ray<  rook,12, 2>::value, ray<  rook,12,3>::value, ray<  rook,12,4>::value, ray<  rook,12,5>::value, ray<  rook,12, 6>::value, ray<  rook,12,7>::value,
            ray<  rook,13, 0>::value, ray<  rook,13,1>::value, ray<  rook,13, 2>::value, ray<  rook,13,3>::value, ray<  rook,13,4>::value, ray<  rook,13,5>::value, ray<  rook,13, 6>::value, ray<  rook,13,7>::value,
            ray<  rook,14, 0>::value, ray<  rook,14,1>::value, ray<  rook,14, 2>::value, ray<  rook,14,3>::value, ray<  rook,14,4>::value, ray<  rook,14,5>::value, ray<  rook,14, 6>::value, ray<  rook,14,7>::value,
            ray<  rook,15, 0>::value, ray<  rook,15,1>::value, ray<  rook,15, 2>::value, ray<  rook,15,3>::value, ray<  rook,15,4>::value, ray<  rook,15,5>::value, ray<  rook,15, 6>::value, ray<  rook,15,7>::value,
            ray<  rook,16, 0>::value, ray<  rook,16,1>::value, ray<  rook,16, 2>::value, ray<  rook,16,3>::value, ray<  rook,16,4>::value, ray<  rook,16,5>::value, ray<  rook,16, 6>::value, ray<  rook,16,7>::value,
            ray<  rook,17, 0>::value, ray<  rook,17,1>::value, ray<  rook,17, 2>::value, ray<  rook,17,3>::value, ray<  rook,17,4>::value, ray<  rook,17,5>::value, ray<  rook,17, 6>::value, ray<  rook,17,7>::value,
            ray<  rook,18, 0>::value, ray<  rook,18,1>::value, ray<  rook,18, 2>::value, ray<  rook,18,3>::value, ray<  rook,18,4>::value, ray<  rook,18,5>::value, ray<  rook,18, 6>::value, ray<  rook,18,7>::value,
            ray<  rook,19, 0>::value, ray<  rook,19,1>::value, ray<  rook,19, 2>::value, ray<  rook,19,3>::value, ray<  rook,19,4>::value, ray<  rook,19,5>::value, ray<  rook,19, 6>::value, ray<  rook,19,7>::value,
            ray<  rook,20, 0>::value, ray<  rook,20,1>::value, ray<  rook,20, 2>::value, ray<  rook,20,3>::value, ray<  rook,20,4>::value, ray<  rook,20,5>::value, ray<  rook,20, 6>::value, ray<  rook,20,7>::value,
            ray<  rook,21, 0>::value, ray<  rook,21,1>::value, ray<  rook,21, 2>::value, ray<  rook,21,3>::value, ray<  rook,21,4>::value, ray<  rook,21,5>::value, ray<  rook,21, 6>::value, ray<  rook,21,7>::value,
            ray<  rook,22, 0>::value, ray<  rook,22,1>::value, ray<  rook,22, 2>::value, ray<  rook,22,3>::value, ray<  rook,22,4>::value, ray<  rook,22,5>::value, ray<  rook,22, 6>::value, ray<  rook,22,7>::value,
            ray<  rook,23, 0>::value, ray<  rook,23,1>::value, ray<  rook,23, 2>::value, ray<  rook,23,3>::value, ray<  rook,23,4>::value, ray<  rook,23,5>::value, ray<  rook,23, 6>::value, ray<  rook,23,7>::value,
            ray<  rook,24, 0>::value, ray<  rook,24,1>::value, ray<  rook,24, 2>::value, ray<  rook,24,3>::value, ray<  rook,24,4>::value, ray<  rook,24,5>::value, ray<  rook,24, 6>::value, ray<  rook,24,7>::value,
            ray<  rook,25, 0>::value, ray<  rook,25,1>::value, ray<  rook,25, 2>::value, ray<  rook,25,3>::value, ray<  rook,25,4>::value, ray<  rook,25,5>::value, ray<  rook,25, 6>::value, ray<  rook,25,7>::value,
            ray<  rook,26, 0>::value, ray<  rook,26,1>::value, ray<  rook,26, 2>::value, ray<  rook,26,3>::value, ray<  rook,26,4>::value, ray<  rook,26,5>::value, ray<  rook,26, 6>::value, ray<  rook,26,7>::value,
            ray<  rook,27, 0>::value, ray<  rook,27,1>::value, ray<  rook,27, 2>::value, ray<  rook,27,3>::value, ray<  rook,27,4>::value, ray<  rook,27,5>::value, ray<  rook,27, 6>::value, ray<  rook,27,7>::value,
            ray<  rook,28, 0>::value, ray<  rook,28,1>::value, ray<  rook,28, 2>::value, ray<  rook,28,3>::value, ray<  rook,28,4>::value, ray<  rook,28,5>::value, ray<  rook,28, 6>::value, ray<  rook,28,7>::value,
            ray<  rook,29, 0>::value, ray<  rook,29,1>::value, ray<  rook,29, 2>::value, ray<  rook,29,3>::value, ray<  rook,29,4>::value, ray<  rook,29,5>::value, ray<  rook,29, 6>::value, ray<  rook,29,7>::value,
            ray<  rook,30, 0>::value, ray<  rook,30,1>::value, ray<  rook,30, 2>::value, ray<  rook,30,3>::value, ray<  rook,30,4>::value, ray<  rook,30,5>::value, ray<  rook,30, 6>::value, ray<  rook,30,7>::value,
            ray<  rook,31, 0>::value, ray<  rook,31,1>::value, ray<  rook,31, 2>::value, ray<  rook,31,3>::value, ray<  rook,31,4>::value, ray<  rook,31,5>::value, ray<  rook,31, 6>::value, ray<  rook,31,7>::value,
            ray<  rook,32, 0>::value, ray<  rook,32,1>::value, ray<  rook,32, 2>::value, ray<  rook,32,3>::value, ray<  rook,32,4>::value, ray<  rook,32,5>::value, ray<  rook,32, 6>::value, ray<  rook,32,7>::value,
            ray<  rook,33, 0>::value, ray<  rook,33,1>::value, ray<  rook,33, 2>::value, ray<  rook,33,3>::value, ray<  rook,33,4>::value, ray<  rook,33,5>::value, ray<  rook,33, 6>::value, ray<  rook,33,7>::value,
            ray<  rook,34, 0>::value, ray<  rook,34,1>::value, ray<  rook,34, 2>::value, ray<  rook,34,3>::value, ray<  rook,34,4>::value, ray<  rook,34,5>::value, ray<  rook,34, 6>::value, ray<  rook,34,7>::value,
            ray<  rook,35, 0>::value, ray<  rook,35,1>::value, ray<  rook,35, 2>::value, ray<  rook,35,3>::value, ray<  rook,35,4>::value, ray<  rook,35,5>::value, ray<  rook,35, 6>::value, ray<  rook,35,7>::value,
            ray<  rook,36, 0>::value, ray<  rook,36,1>::value, ray<  rook,36, 2>::value, ray<  rook,36,3>::value, ray<  rook,36,4>::value, ray<  rook,36,5>::value, ray<  rook,36, 6>::value, ray<  rook,36,7>::value,
            ray<  rook,37, 0>::value, ray<  rook,37,1>::value, ray<  rook,37, 2>::value, ray<  rook,37,3>::value, ray<  rook,37,4>::value, ray<  rook,37,5>::value, ray<  rook,37, 6>::value, ray<  rook,37,7>::value,
            ray<  rook,38, 0>::value, ray<  rook,38,1>::value, ray<  rook,38, 2>::value, ray<  rook,38,3>::value, ray<  rook,38,4>::value, ray<  rook,38,5>::value, ray<  rook,38, 6>::value, ray<  rook,38,7>::value,
            ray<  rook,39, 0>::value, ray<  rook,39,1>::value, ray<  rook,39, 2>::value, ray<  rook,39,3>::value, ray<  rook,39,4>::value, ray<  rook,39,5>::value, ray<  rook,39, 6>::value, ray<  rook,39,7>::value,
            ray<  rook,40, 0>::value, ray<  rook,40,1>::value, ray<  rook,40, 2>::value, ray<  rook,40,3>::value, ray<  rook,40,4>::value, ray<  rook,40,5>::value, ray<  rook,40, 6>::value, ray<  rook,40,7>::value,
            ray<  rook,41, 0>::value, ray<  rook,41,1>::value, ray<  rook,41, 2>::value, ray<  rook,41,3>::value, ray<  rook,41,4>::value, ray<  rook,41,5>::value, ray<  rook,41, 6>::value, ray<  rook,41,7>::value,
            ray<  rook,42, 0>::value, ray<  rook,42,1>::value, ray<  rook,42, 2>::value, ray<  rook,42,3>::value, ray<  rook,42,4>::value, ray<  rook,42,5>::value, ray<  rook,42, 6>::value, ray<  rook,42,7>::value,
            ray<  rook,43, 0>::value, ray<  rook,43,1>::value, ray<  rook,43, 2>::value, ray<  rook,43,3>::value, ray<  rook,43,4>::value, ray<  rook,43,5>::value, ray<  rook,43, 6>::value, ray<  rook,43,7>::value,
            ray<  rook,44, 0>::value, ray<  rook,44,1>::value, ray<  rook,44, 2>::value, ray<  rook,44,3>::value, ray<  rook,44,4>::value, ray<  rook,44,5>::value, ray<  rook,44, 6>::value, ray<  rook,44,7>::value,
            ray<  rook,45, 0>::value, ray<  rook,45,1>::value, ray<  rook,45, 2>::value, ray<  rook,45,3>::value, ray<  rook,45,4>::value, ray<  rook,45,5>::value, ray<  rook,45, 6>::value, ray<  rook,45,7>::value,
            ray<  rook,46, 0>::value, ray<  rook,46,1>::value, ray<  rook,46, 2>::value, ray<  rook,46,3>::value, ray<  rook,46,4>::value, ray<  rook,46,5>::value, ray<  rook,46, 6>::value, ray<  rook,46,7>::value,
            ray<  rook,47, 0>::value, ray<  rook,47,1>::value, ray<  rook,47, 2>::value, ray<  rook,47,3>::value, ray<  rook,47,4>::value, ray<  rook,47,5>::value, ray<  rook,47, 6>::value, ray<  rook,47,7>::value,
            ray<  rook,48, 0>::value, ray<  rook,48,1>::value, ray<  rook,48, 2>::value, ray<  rook,48,3>::value, ray<  rook,48,4>::value, ray<  rook,48,5>::value, ray<  rook,48, 6>::value, ray<  rook,48,7>::value,
            ray<  rook,49, 0>::value, ray<  rook,49,1>::value, ray<  rook,49, 2>::value, ray<  rook,49,3>::value, ray<  rook,49,4>::value, ray<  rook,49,5>::value, ray<  rook,49, 6>::value, ray<  rook,49,7>::value,
            ray<  rook,50, 0>::value, ray<  rook,50,1>::value, ray<  rook,50, 2>::value, ray<  rook,50,3>::value, ray<  rook,50,4>::value, ray<  rook,50,5>::value, ray<  rook,50, 6>::value, ray<  rook,50,7>::value,
            ray<  rook,51, 0>::value, ray<  rook,51,1>::value, ray<  rook,51, 2>::value, ray<  rook,51,3>::value, ray<  rook,51,4>::value, ray<  rook,51,5>::value, ray<  rook,51, 6>::value, ray<  rook,51,7>::value,
            ray<  rook,52, 0>::value, ray<  rook,52,1>::value, ray<  rook,52, 2>::value, ray<  rook,52,3>::value, ray<  rook,52,4>::value, ray<  rook,52,5>::value, ray<  rook,52, 6>::value, ray<  rook,52,7>::value,
            ray<  rook,53, 0>::value, ray<  rook,53,1>::value, ray<  rook,53, 2>::value, ray<  rook,53,3>::value, ray<  rook,53,4>::value, ray<  rook,53,5>::value, ray<  rook,53, 6>::value, ray<  rook,53,7>::value,
            ray<  rook,54, 0>::value, ray<  rook,54,1>::value, ray<  rook,54, 2>::value, ray<  rook,54,3>::value, ray<  rook,54,4>::value, ray<  rook,54,5>::value, ray<  rook,54, 6>::value, ray<  rook,54,7>::value,
            ray<  rook,55, 0>::value, ray<  rook,55,1>::value, ray<  rook,55, 2>::value, ray<  rook,55,3>::value, ray<  rook,55,4>::value, ray<  rook,55,5>::value, ray<  rook,55, 6>::value, ray<  rook,55,7>::value,
            ray<  rook,56, 0>::value, ray<  rook,56,1>::value, ray<  rook,56, 2>::value, ray<  rook,56,3>::value, ray<  rook,56,4>::value, ray<  rook,56,5>::value, ray<  rook,56, 6>::value, ray<  rook,56,7>::value,
            ray<  rook,57, 0>::value, ray<  rook,57,1>::value, ray<  rook,57, 2>::value, ray<  rook,57,3>::value, ray<  rook,57,4>::value, ray<  rook,57,5>::value, ray<  rook,57, 6>::value, ray<  rook,57,7>::value,
            ray<  rook,58, 0>::value, ray<  rook,58,1>::value, ray<  rook,58, 2>::value, ray<  rook,58,3>::value, ray<  rook,58,4>::value, ray<  rook,58,5>::value, ray<  rook,58, 6>::value, ray<  rook,58,7>::value,
            ray<  rook,59, 0>::value, ray<  rook,59,1>::value, ray<  rook,59, 2>::value, ray<  rook,59,3>::value, ray<  rook,59,4>::value, ray<  rook,59,5>::value, ray<  rook,59, 6>::value, ray<  rook,59,7>::value,
